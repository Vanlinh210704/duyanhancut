...
<body>
    ...
    <header>
            ...
            <div class="buttom-logout-to-interface">
                <div class='hello-logout'>
                    <div class='item-hello-logout'>
                        <?php echo "<a class='logout'>" . "Hello " . $_SESSION['first_name'] . "<i class='fa-solid fa-caret-down fa-2xl icon-item-hello' style='color: #ffffff;'></i>" ."</a>";?>
        ...
        <nav class="menu">
            ...
            <div class="item-menu"><a class="text-item-menu" href="skill.html">Skills</a></div>
            <div class="item-menu"><a class="text-item-menu" href="grammar.html">Grammar</a></div>
            <div class="item-menu"><a class="text-item-menu" href="vocabulary.html">Vocabulary</a></div>
            <div class="item-menu"><a class="text-item-menu" href="businessEnglish.html">Business English</a></div>
    ...
    <content class="content">
        ...
        <div class="content-header">
            ...
            <div class="content-header-logo wapper-text">
                <p>
                    Learn English online and improve
                    your skills through our high-quality
        ...
        <div class="box-important-english">
            <div class="important-english">
                <b class="text-important-english">We provide you with the right tools to help you <span>interact
                        confidently in the real world.</span></b>
            </div>
            ...
            <div class="start-english skills">
                ...
                <div class="text-start-learning">
                    ...
                    <p class="text-start">Practise your listening, reading, writing and speaking and learn useful
                        language to use at work or to communicate effectively with friends.</p>
                    <ul>
            ...
            <div class="start-english grammar">
                <div class="text-start-learning">
                    ...
                    <p class="text-start">Revise and practise your grammar to improve your language level and increase
                        your confidence.</p>
                    <ul>
                        <li>Clear and simple grammar explanations to help you revise and practise different grammar
                            points.</li>
                ...
                <div><img class="img-grammar-start" src="image/grammar-start-learning.jpg" alt="grammar-start-english">
                </div>
            </div>


            <div class="start-english vocabulary">
                <div><img class="img-skill-start" src="image/vocabulary-start-learning.jpg" alt="skill-start-english">
                </div>
                <div class="text-start-learning">
                    <p class="header-text-start">Vocabulary</p>
                    <p class="text-start">Learn new words and improve your language level to be able to communicate in
                        English effectively.</p>
                    <ul>
                        <li>Online exercises to help you learn the meaning, pronunciation and spelling of new words.
                        </li>
        ...
        <div class="important-topic">
            <div class="item-important-topic topic">
                ...
                <div>
                    <p class="text-topic"><a href="">Understand your English level</a></p>
                </div>
                <div>
            ...
            <div class="item-important-topic topic">
                ...
                <div>
                    <p class="text-topic"><a href="">Free online English test</a></p>
                </div>
                <div>
        ...
        <div class="box-footer">
            ...
            <div class="content-footer-left">
                <div class="header-menu-footer">
                    <p>Learn English British Council</p>
                </div>
                <div class="footer-left">
                    <a href="" target="_blank" class="text-content-footer-left"><i
                            class="item-footer-left fa-solid fa-location-dot"></i>10 Tran Phu, Ha Dong</a>
                </div>
                <div class="footer-left">
                    <a href="tel:018001299" target="_blank" class="text-content-footer-left"><i
                            class="item-footer-left fa-solid fa-phone"></i>018001299</a>
                </div>
                <div class="footer-left">
                    <a href="mailto:bchanoi@britishcouncil.org.vn" target="_blank" class="text-content-footer-left"><i
                            class="item-footer-left fa-solid fa-envelope"></i>bchanoi@britishcouncil.org.vn</a>
                </div>
                <div class="bottom-left-footer">
                    <div><a href="https://www.facebook.com/" target="_blank"><i
                                class="item-footer-left-bottom fa-brands fa-facebook fa-2xl"></i></a></div>
                    <div><a href="https://www.tiktok.com/vi-VN/" target="_blank"><i
                                class="item-footer-left-bottom fa-brands fa-tiktok fa-2xl"></i></a></div>
                    <div><a href="https://www.instagram.com/" target="_blank"><i
                                class="item-footer-left-bottom fa-brands fa-square-instagram fa-2xl"></i></a></div>
                    <div><a href="https://www.youtube.com/" target="_blank"><i
                                class="item-footer-left-bottom fa-brands fa-youtube fa-2xl"></i></a></div>
                    <div><a href="https://twitter.com/?lang=vi" target="_blank"><i
                                class="item-footer-left-bottom fa-brands fa-twitter fa-2xl"></i></a></div>
                </div>
            </div>
