...
<body>
    ...
    <header>
        <div class="home-page">
            ...
            <div class="buttom-logout-to-interface">
                ...
                <div class="icon-menu">
                    ...
                    <div class="menu-drop">
                        <a class="text-item-menu" href="online_">Class</a>
                        <a class="item-menu-drop" href="skill.html">Online Courses</a>
        ...
        <nav class="menu">
            ...
            <div class="item-menu"><a class="text-item-menu" href="online_">Class</a></div>
